...
public class PruebasController {
    ...
    @GetMapping("/listado") //Listado para traernos la información para las asociaciones de categoria y productos
    ...
    @GetMapping("/listado2") //Listado 2 es para la parte de consultas (filtros de SQL credos en el código)
